...
[.center, cols=".^"]
|===
|image:mat_unor3.png["Arduino UNO",50,50] 2x Arduino Uno o equivalente.
|image:mat_cables.png["Cables",50,50] Cables de connexió
|image:mat_KY-022.png["Mòdul receptor IR KY022",50,50] Mòdul receptor IR KY022
|image:mat_KY-005.png["Mòdul emissor IR KY005",50,50] Mòdul emissor IR KY005
|===
...
[.text-center]
.Mòdul receptor IR
image::ard_13_01.png["Receptor IR",width=593,height=198]
...
[.text-center]
.Modul emissor IR
image::ard_13_02.png[Transmissor IR,width=642,height=205]
...
--
[.left]
.Diagrama muntatge receptor
image::ard_13_03.png["Esquema de muntatge del receptor",width=255]

[.right]
.Diagrama muntatge emissor
image::ard_13_05.png["Esquema de muntatge del transmissor",width=255]
--
...
--
[.left]
.Esquema elèctric receptor
image::ard_13_04.png["Esquema electrònic del receptor",width=255]

[.right]
.Esquema elèctric emissor
image::ard_13_06.png["Esquema electrònic del transmissor",width=255]
--
